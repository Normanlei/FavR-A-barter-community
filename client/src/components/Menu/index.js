    ...
    return (
        <AppBar style={classes.menu}>
            <Toolbar>
                ...
                <div>
                    {history.location.pathname.includes("/user") || history.location.pathname.includes("/barter") || history.location.pathname.includes("/profile") || history.location.pathname.includes("/other") ? (
                        null
                    ) : (
                            <Link to="/">
